...
public class eCommerce_tc_4_hybrid extends BaseTest  {
	...
	public void set() throws InterruptedException  {
		 ...
		 Double toatlamountinthewebpageshown = Double.parseDouble(totalamount.substring(1));
		 Assert.assertEquals(totalsum, toatlamountinthewebpageshown);
		 ...
		 //get from dev or use above contexthandle
		 
		 driver.context("WEBVIEW_com.androidsample.generalstore");
		 driver.findElement(By.name("q")).sendKeys("rubapranesh");
